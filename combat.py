...
CLASS_ABILITIES = {
    "NetRunner": {
        ...
        # New tactical combat moves
        "neural_overload": {
            "name": "Neural Overload",
            "description": "Overload enemy's neural implants, bypassing physical defenses",
        ...
        "system_glitch": {
            "name": "System Glitch",
            "description": "Introduce errors in enemy cybernetics that scramble their position",
            "damage_multiplier": 0.8,
            "status_effect": "disoriented",
            "required_position": "center",
            "target_zone": "any",
            "cooldown": 3,
            "tactical": True,
            "position_effect": "random"
        },
        "ice_breaker": {
            "name": "ICE Breaker",
            "description": "Break through enemy's Intrusion Countermeasures to damage cover",
    ...
    "Enforcer": {
        ...
        "breaching_charge": {
            ...
            "description": "Deploy explosive to destroy enemy cover and cause damage",
        ...
        "suppressive_fire": {
            ...
            "description": "Pin down enemies, restricting their movement and forcing defensive posture",
            "damage_multiplier": 0.7,
            "status_effect": "pinned",
            "required_position": "center",
            "target_zone": "any",
            "cooldown": 3,
            "tactical": True,
            "position_effect": "force_center"
        },
        "ballistic_rush": {
            "name": "Ballistic Rush",
            "description": "Charge forward while firing, closing distance and disrupting enemy position",
            "damage_multiplier": 1.1,
            "required_position": "any",
            "target_zone": "torso",
            "cooldown": 3,
            "tactical": True,
            "position_effect": "close_distance"
        }
    },
    "Fixer": {
        "analyze_weakness": {
        ...
        "street_feint": {
            "name": "Street Feint",
            "description": "Use street-fighting techniques to fake out enemy and gain tactical advantage",
            "damage_multiplier": 0.8,
            "required_position": "any",
            "target_zone": "any",
            "cooldown": 2,
            "tactical": True,
            "position_effect": "improve_position"
        },
        "black_market_stim": {
            "name": "Black Market Stim",
            "description": "Inject illegal combat stimulant that enhances reflexes and combat awareness",
            "self_buff": "heightened_reflexes",
            "duration": 3,
            "self_damage": 2,
            "required_position": "any",
            "cooldown": 5,
        ...
        "mark_target": {
            "name": "Mark Target",
            "description": "Identify critical weakpoints, allowing precise targeting of specific body zones",
            "damage_multiplier": 1.0,
            "target_zone_bonus": True,
            "required_position": "center",
            "target_zone": "any",
            "cooldown": 3,
            "tactical": True,
    ...
    "Tech": {
        ...
        "deployable_cover": {
            ...
            "description": "Deploy portable shield that provides heavy cover",
            "create_cover": "medium",
            "cover_health": 6,
            "required_position": "any",
            "cooldown": 4,
        ...
        "emp_pulse": {
            "name": "EMP Pulse",
            "description": "Emit electromagnetic pulse that disrupts cyber-enhanced enemies",
            "damage_multiplier": 1.2,
            ...
            "tactical": True,
            "position_effect": None,
            "enemy_type_bonus": "cybernetic"
        },
        "nanite_cloud": {
            "name": "Nanite Cloud",
            "description": "Deploy cloud of programmable nanites that damage enemies and enhance cover",
            "damage_multiplier": 0.7,
            "area_effect": True,
            "cover_boost": 2,
            "required_position": "any",
...
def run_combat(console, player, enemy, player_damage_multiplier=1.0, use_animations=True, audio_system=None, environment="standard"):
    ...
    while combat_active:
        ...
        if "stunned" in player.status_effects:
            ...
            # Update combat state with current tactical information
            combat_state.update({
                "player_position": getattr(player, "position", "center"),
                "enemy_position": getattr(enemy, "position", "center"),
                "player_cover": player.current_cover,
                "enemy_cover": enemy.current_cover
            })
            
            # Use tactical_abilities module for handling abilities
            combat_state, ability_result = tactical_abilities.handle_tactical_ability(
                player, selected_ability, enemy, combat_state, console, audio_system
            )
            ...
            for ability_id, ability_data in available_abilities.items():
                if "smooth_talk" in ability_id:  # Check for the Fixer's Smooth Talk ability
                    # Use the ability with combat state
                    updated_combat_state, ability_result = tactical_abilities.handle_tactical_ability(
                        player, ability_id, enemy, combat_state, console, audio_system
                    )
